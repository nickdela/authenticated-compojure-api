...
(defqueries "authenticated_compojure_api/queries/registered_user.sql"    db-connection)
...
(defqueries "authenticated_compojure_api/queries/password_reset_key.sql" db-connection)
