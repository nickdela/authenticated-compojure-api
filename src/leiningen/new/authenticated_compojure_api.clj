...
(defn authenticated-compojure-api
  ...
  (let [data {:name      name
    ...
    (->files data
             ...
             ["src/{{sanitized}}/queries/user/refresh_token.sql"                         (render "src/authenticated_compojure_api/queries/user/refresh_token.sql"                             ) ]
             ...
             ["src/{{sanitized}}/tables/user/refresh_token.sql"                          (render "src/authenticated_compojure_api/tables/user/refresh_token.sql"                              ) ]
             ...
             ["test/{{sanitized}}/refresh_token/generating_refresh_token_tests.clj"      (render "test/authenticated_compojure_api/refresh_token/generating_refresh_token_tests.clj"      data) ]
